  ...
  <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Help Center</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Customers</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Legal Doc</a></p>
        </div>
      </div>
