  ...
  <div className="max-w-[85rem] py-10 lg:pt-20 mx-auto">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          <p><NavLink to="/" className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Home</NavLink></p>
          <p><NavLink to="/products" className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Products</NavLink></p>
          ...
          <p><NavLink to="/faq" className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">FAQ</NavLink></p>
        </div>
      </div>
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          <p><NavLink to="/about-us" className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">About Us</NavLink></p>
          <p><NavLink to="/contact-us" className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Contact Us</NavLink></p>
        </div>
      </div>
    ...
    <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-400">© 2023 Secure Capital Trades. All rights reserved.</p>
      </div>
